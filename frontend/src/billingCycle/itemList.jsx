...
class ItemList extends Component {
    ...
    // Adiciona novos elementos na lista de créditos
    add(index, item = {}) {
        if (!this.props.readOnly) {
            this.props.arrayInsert('billingCycleForm', this.props.field,
                index, item)
        }
    }

    remove(index) {
        // Só removo se não for readonly e deve existir ao menos dois elementos
